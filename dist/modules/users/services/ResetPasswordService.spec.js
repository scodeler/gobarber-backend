...
var FakeUserTokensRepository_1 = __importDefault(require("@modules/users/repositories/fakes/FakeUserTokensRepository"));
...
describe('ResetPasswordService', function () {
    ...
    it('should be able to reset the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var userData, user, token, generateHash, newPassword, updatedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    newPassword = faker_1.default.internet.password();
    ...
    it('should not be able to reset password with non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUserTokensRepository.generate('not-a-valid-user')];
                case 1:
                    token = (_a.sent()).token;
    ...
    it('should not be able to reset password if token is older than 2 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
